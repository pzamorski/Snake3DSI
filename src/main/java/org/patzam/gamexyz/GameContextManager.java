...
//
//
//        int absoluteDifferenceXsnakePosition = head.getAbsoluteDifferenceX(foodPosition);
//        int absoluteDifferenceYsnakePosition = head.getAbsoluteDifferenceY(foodPosition);
//        int absoluteDifferenceZsnakePosition = head.getAbsoluteDifferenceZ(foodPosition);
//
